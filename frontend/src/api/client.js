...
export const api = {
  ...
  removeTitleCardBackground: (id, variantId, method) => request(`${projectPath(id)}/title-card/variants/${encodeURIComponent(variantId)}/remove-background`, { method: 'POST', body: JSON.stringify({ method }) }),
