import { CheckCircle2, Circle, Clapperboard, Loader, ListMusic, Minus, Music2 } from 'lucide-react';
...
function stageDefs(L) {
  return [
    ...
    { key: 'scenes', name: L.stage_scenes, icon: Clapperboard, sub: [L.sub_script, L.sub_images, L.sub_rating] },
  ];
}
