    ...
    return [
        {
            ...
            'skill_id': 'skill_a',
            'skill_prompt': 'Transform the following structured lyrics into a music-service-ready format using strict bracket tags [Verse], [Chorus], [Bridge], [Fade Out]. Optimize rhythm for singing, keep original imagery.',
            'refinement_comments': [],
            'active_wish_ids': [],
        ...
        },
        {
            ...
            'skill_id': 'skill_a',
            'skill_prompt': 'Transform the following structured lyrics into a music-service-ready format using strict bracket tags. Emphasize intimate, conversational phrasing suited to a slow tempo.',
            'refinement_comments': [],
            'active_wish_ids': [],
        ...
        },
        {
            ...
            'skill_id': 'skill_a',
            'skill_prompt': 'Transform the following structured lyrics into a music-service-ready format using strict bracket tags [Verse], [Chorus], [Fade Out].',
            'refinement_comments': [],
            'active_wish_ids': [],
